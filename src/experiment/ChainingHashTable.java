...
public class ChainingHashTable<K, V> extends DeletelessDictionary<K, V> {
    ...
    private final static int[] PRIMES = {101, 211, 409, 821, 1657, 3299, 6599, 12163, 24391, 48821, 97073, 202309, 48821, 97073, 202309, 406981, 813647, 1621079};
